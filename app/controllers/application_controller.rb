class ApplicationController < ActionController::Base
  ...
  around_action :scope_current_studio, :studio_time_zone, unless: :devise_controller?
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.permit(:account_update) { |u| u.permit(:password, :password_confirmation, :reset_password_token) }
  end
end
